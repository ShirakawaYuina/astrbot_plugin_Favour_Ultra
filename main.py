...
"""
    ...
    @filter.command(
        "查询好感度", alias={"查好感度", "好感度查询", "查看好感度", "好感度"}
    )
    ...
    @filter.command(
        "查询全部好感度", alias={"查全部好感度", "查看全部好感度", "全部好感度"}
    )
    ...
    @filter.command(
        "查询全局好感度",
        alias={"全局好感度", "查全局好感度", "查看全局好感度", "全局好感度查询"},
    )
